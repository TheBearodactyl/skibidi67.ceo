use {
    crate::{
        ...
        routes::media::{
            self, ALLOWED_VIDEO_TYPES, CommentBody, CommentsDisabledPatch, MediaResponse, MetaPatch,
...
#[patch("/videos/<id>", format = "json", data = "<body>")]
pub fn patch_meta(
    id: &str,
    body: Json<MetaPatch>,
    user: AuthenticatedUser,
...
#[patch("/videos/<_id>", format = "json", data = "<_body>", rank = 2)]
