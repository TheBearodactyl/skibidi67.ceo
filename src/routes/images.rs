...
#[post(
    "/images/upload?<title>&<source_name>&<source_link>&<nsfw>&<unlisted>&<comments_disabled>",
    data = "<data>"
)]
...
#[post(
    "/images/upload/<upload_id>/complete?<title>&<source_name>&<source_link>&<nsfw>&<unlisted>&<comments_disabled>"
)]
...
#[post(
    "/images/upload/<_upload_id>/complete?<_title>&<_source_name>&<_source_link>&<_nsfw>&<_unlisted>&<_comments_disabled>",
    rank = 2
)]
