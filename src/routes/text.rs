use {
    crate::{
        ...
        routes::media::{
            self, ALLOWED_TEXT_TYPES, CommentBody, CommentsDisabledPatch, MediaResponse, MetaPatch,
...
#[patch("/text/<id>", format = "json", data = "<body>")]
pub fn patch_meta(
    id: &str,
    body: Json<MetaPatch>,
    user: AuthenticatedUser,
...
#[patch("/text/<_id>", format = "json", data = "<_body>", rank = 2)]
