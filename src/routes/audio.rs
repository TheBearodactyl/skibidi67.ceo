...
pub async fn upload_audio(
    ...
    media::handle_upload(title, nsfw, unlisted, comments_disabled, data, content_type, user, state, ALLOWED_AUDIO_TYPES, None).await
}
...
pub async fn complete_upload(
    ...
    media::handle_complete_upload(upload_id, title, nsfw, unlisted, comments_disabled, user, state, ALLOWED_AUDIO_TYPES, None).await
}
