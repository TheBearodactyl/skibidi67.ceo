use {
    crate::{
        ...
        routes::media::{
            self, ALLOWED_AUDIO_TYPES, CommentBody, CommentsDisabledPatch, MediaResponse, MetaPatch,
...
#[patch("/audio/<id>", format = "json", data = "<body>")]
pub fn patch_meta(
    id: &str,
    body: Json<MetaPatch>,
    user: AuthenticatedUser,
...
#[patch("/audio/<_id>", format = "json", data = "<_body>", rank = 2)]
